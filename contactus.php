    ...
    <div class="row">
        ...
        <h2>Contact Us</h2>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="subject" placeholder="Your Name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                <div id="textHelp" class="form-text">We'll never share your email with anyone else.</div>
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Message</label>
                <textarea class="form-control" name="message" id="exampleInputEmail1" aria-describedby="messageHelp" rows="5"></textarea>
