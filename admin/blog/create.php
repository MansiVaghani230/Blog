                            ...
                            <div class="card-body pt-0">
                                <form name="blog" id="blog" class="validate-form1 needs-validation"
                                    ...
                                    <div class="input-form mb-1">
                                            ...
                                            <input type="text" id="title" name="title" class="form-control " value="" placeholder="Enter Your title" autofocus required /> 
                                    </div> 
                                    <div class="input-form mb-1">
                                    ...
                                    <div class="input-form mb-1">
                                            ...
                                            <input type="file" id="image" name="image" class="form-control " value="" placeholder="Enter Your image" autofocus required /> 
                                    </div>  
                                    <div class="input-form mb-1">
                                            <label class="form-label" for="description">Description<span  class="text-danger">*</span></label>
                                            <input type="text" id="description" name="description" class="form-control " value="" placeholder="Enter Your Description" autofocus required /> 
                                    </div> 
                                     <!--End Form Field  -->
                                     <hr>
